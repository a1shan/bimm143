...
1.  import metadata and take a peak
...
1.  import countdata and take a peak
...
1.  filter countData to remove all genes that have 0 reads for all samples
...
1.  compare HoxA1 KO vs control siRNA
...
![](class16_files/figure-markdown_github/unnamed-chunk-7-2.png)

1.  adding gene annotation
...
1.  reorder results by adjusted p-value and save to csv file
...
```
    ...
    ##  C:\Users\Alyssa Shan\AppData\Local\Temp\RtmpSWk1kF\downloaded_packages
    ...
    ## Old packages: 'Rcpp', 'stringi', 'tinytex', 'xfun'

1.  setup KEGG data sets
...
1.  set up main gage to a named vector of fold changes
...
1.  view down/up regulated pathway
...
```
    ...
    ## Info: Working in directory C:/Users/Alyssa Shan/Desktop/BIMM143_FAD/bimm143/class16
